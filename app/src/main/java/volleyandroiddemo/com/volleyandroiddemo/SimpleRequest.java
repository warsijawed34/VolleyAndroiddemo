...
public class SimpleRequest extends AppCompatActivity implements View.OnClickListener {
    ...
    private String url_contact = "http://www.google.com";
    ...
    private void simpleRequest() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url_contact, new Response.Listener<String>() {
            @Override
    ...
    private void setRequestQueue() {
        ...
        requestQueue.start();
        StringRequest stringRequest1 = new StringRequest(Request.Method.GET, url_contact, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                tvDisplay.setText("Response is: " + response.substring(0, 500));
                requestQueue.stop();
